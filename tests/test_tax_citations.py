...
class TestTaxCitations:
    ...
    def test_get_citation_returns_formatted_string(self):
        ...
        from tax_references.citations import get_citation
    ...
    def test_all_top_20_citations_exist(self):
        ...
        from tax_references.citations import get_citation, TOP_20_TOPICS
...
class TestCitationIntegration:
    ...
    def test_detect_topics_finds_multiple(self):
        ...
        from tax_references.citations import detect_topics
