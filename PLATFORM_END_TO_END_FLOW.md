...
| Role | Description | Access Level |
|------|-------------|--------------|
| **DIRECT_CLIENT** | Self-service taxpayer | DIY filers |

#### LEVEL 2: FIRM CLIENT (B2B2C)
| Role | Description | Access Level |
|------|-------------|--------------|
| **FIRM_CLIENT** | Taxpayer managed by CPA firm | Managed by CPA |
...
| E-File Returns | Electronic filing |
...
### B2C Flow (Direct Client)

```
┌─────────────┐     ┌─────────────┐     ┌─────────────┐
│ Land on     │────▶│ Upload 1040 │────▶│ Create      │
│ Platform    │     │ or Estimate │     │ Account     │
└─────────────┘     └─────────────┘     └─────────────┘
                                               │
                                               ▼
┌─────────────┐     ┌─────────────┐     ┌─────────────┐
│ Access      │◀────│ File        │◀────│ Guided Tax  │
│ Portal      │     │ Return      │     │ Filing      │
└─────────────┘     └─────────────┘     └─────────────┘
```
