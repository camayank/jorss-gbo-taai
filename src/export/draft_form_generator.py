...
class DraftFormPDFGenerator:
    ...
    def _add_watermark(self, canvas_obj, doc):
        ...
        canvas_obj.drawString(
            inch,
            0.5 * inch,
            f"DRAFT - For Review Only | Generated {datetime.now().strftime('%m/%d/%Y %I:%M %p')} | Page {page_num}"
        )
    ...
    def generate_form_1040(
        ...
        story.append(Paragraph(
            "DRAFT - FOR REVIEW PURPOSES ONLY. This is not a final tax return. "
            "Do not file this document with the IRS. All figures are preliminary "
            "and subject to change. Generated by AI Tax Assistant.",
