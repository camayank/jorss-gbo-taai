...
# Auth pages (login, signup, forgot-password, MFA, post-login-redirect)
# moved to web/routers/auth_pages.py
...
def smart_tax_redirect(request: Request, path: str = ""):
    ...
    Redirects all /smart-tax traffic to the unified AI advisor.
    """
    return RedirectResponse(url="/intelligent-advisor", status_code=302)
...
# Interview/validation API and HTMX partials
# moved to web/routers/interview_api.py
...
# EntityComparisonRequest, SalaryAdjustmentRequest, RetirementAnalysisRequest
# moved to web/routers/tax_tools.py
...
# Entity comparison, retirement analysis, and smart insights
# moved to web/routers/tax_tools.py
