...
# =============================================================================
# REPORT ROUTES — moved to web/advisor/report_routes.py
# Included via router.include_router() below.
# =============================================================================
...
async def get_ai_metrics(_ctx=Depends(require_platform_admin)):
...
async def get_routing_stats(_ctx=Depends(require_platform_admin)):
