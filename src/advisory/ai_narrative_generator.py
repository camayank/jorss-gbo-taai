...
class AINarrativeGenerator:
    ...
    async def generate_executive_summary(
        ...
        analysis = scrub_for_ai(analysis)
...
Include a brief note that this analysis was generated by AI and should be verified by a licensed tax professional.
...
_narrative_generator_lock = __import__('threading').Lock()


def get_narrative_generator() -> AINarrativeGenerator:
    """Get the singleton narrative generator instance (thread-safe)."""
    global _narrative_generator
    if _narrative_generator is None:
        with _narrative_generator_lock:
            if _narrative_generator is None:
